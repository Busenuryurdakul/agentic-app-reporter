		...
		r.Group(func(r chi.Router) {
			...
			if deps.TenantHandler != nil {
				r.Route("/organizations", func(r chi.Router) {
					// Authenticated users can create an organization and list their memberships.
					...
					r.Route("/{orgId}", func(r chi.Router) {
						...
						r.Route("/workspaces", func(r chi.Router) {
							r.With(maybeRequirePermission(deps.RBACService, "workspace:write")).Post("/", deps.TenantHandler.CreateWorkspace)
							r.With(maybeRequirePermission(deps.RBACService, "workspace:read")).Get("/", deps.TenantHandler.ListWorkspaces)
							r.Route("/{workspaceId}", func(r chi.Router) {
								r.With(maybeRequirePermission(deps.RBACService, "workspace:read")).Get("/", deps.TenantHandler.GetWorkspace)
								r.With(maybeRequirePermission(deps.RBACService, "workspace:write")).Put("/", deps.TenantHandler.UpdateWorkspace)
								r.With(maybeRequirePermission(deps.RBACService, "workspace:write")).Delete("/", deps.TenantHandler.DeleteWorkspace)
							})
						})
